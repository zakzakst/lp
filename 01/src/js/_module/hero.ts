...
export class Hero {
  ...
  constructor(
    heroElClass: string,
    mvItemElClass: string,
    mvImgElClass: string
  ) {
    this.heroEl = document.getElementById(heroElClass);
    this.mvItemEls = document.getElementsByClassName(mvItemElClass);
    this.mvImgClassName = mvImgElClass;
    this.mvCurrent = 0;
